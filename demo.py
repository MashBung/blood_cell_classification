...
result = classifier.predict("platelet_2181.png")
...
# ============================================
print("\n=== 방법 2: 모든 확률 보기 ===")
result = classifier.predict("platelet_2181.png", return_all_probs=True)
...
# ============================================
print("\n=== 방법 3: 상위 3개 예측 ===")
top3 = classifier.predict_top_k("platelet_2181.png", k=3)
...
# ============================================
print("\n=== 방법 4: 여러 이미지 일괄 예측 ===")
image_paths = ["platelet_2181.png", "neutrophil_123.png", "lymphocyte_456.png"]
...
for result in results:
    if "error" in result:
        ...
        print(
            f"{result['image_path']}: {result['class']} ({result['confidence']:.2f}%)"
        )
...
# ============================================
print("\n=== 방법 5: 한 줄로 예측 ===")
result = quick_predict("best_model.pth", "platelet_2181.png")
